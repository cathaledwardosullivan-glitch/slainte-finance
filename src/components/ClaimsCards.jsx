        ...
        <div className="rounded-lg shadow-md p-6" style={{ backgroundColor: COLORS.white, border: `1px solid ${COLORS.lightGray}` }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="p-4 rounded-lg" style={{ backgroundColor: `${COLORS.slainteBlue}15` }}>
                    ...
                    <p className="text-2xl font-bold" style={{ color: COLORS.darkGray }}>{data.totalSTCClaims.toLocaleString()}</p>
                </div>
                <div className="p-4 rounded-lg" style={{ backgroundColor: `${COLORS.incomeColor}15` }}>
                    ...
                    <p className="text-2xl font-bold" style={{ color: COLORS.darkGray }}>{data.totalSTCClaimsPaid.toLocaleString()}</p>
                </div>
                <div className="p-4 rounded-lg" style={{ backgroundColor: `${COLORS.highlightYellow}30` }}>
                    <h4 className="font-semibold" style={{ color: COLORS.darkGray }}>Annual Leave Balance</h4>
                    <p className="text-2xl font-bold" style={{ color: COLORS.darkGray }}>{data.totalAnnualLeaveBalance.toLocaleString()}</p>
                </div>
                <div className="p-4 rounded-lg" style={{ backgroundColor: `${COLORS.expenseColor}15` }}>
                    ...
                    <p className="text-2xl font-bold" style={{ color: COLORS.darkGray }}>{data.totalStudyLeaveBalance.toLocaleString()}</p>
                </div>
            </div>
        </div>
    );

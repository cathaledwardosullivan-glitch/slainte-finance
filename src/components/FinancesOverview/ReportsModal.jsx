...
/**
 * ReportsModal - Full-screen modal wrapper for Reports
 * Used in Finances Overview to access reports without leaving the page
 */
const ReportsModal = ({ isOpen, onClose, setCurrentView }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ReportsSection setCurrentView={setCurrentView} />
        </div>
      </div>
    </div>
  );

        ...
        <div className="rounded-lg shadow-md p-6" style={{ backgroundColor: COLORS.white, border: `1px solid ${COLORS.borderLight}` }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 rounded-lg" style={{ backgroundColor: `${COLORS.slainteBlue}15` }}>
                    ...
                    <p className="text-2xl font-bold" style={{ color: COLORS.textPrimary }}>{data.totalPanelSize.toLocaleString()}</p>
                </div>
                <div className="p-4 rounded-lg" style={{ backgroundColor: `${COLORS.slainteBlue}20` }}>
                    ...
                    <p className="text-2xl font-bold" style={{ color: COLORS.textPrimary }}>{data.totalPatientsOver70.toLocaleString()}</p>
                </div>
                <div className="p-4 rounded-lg" style={{ backgroundColor: `${COLORS.highlightYellow}30` }}>
                    <h4 className="font-semibold" style={{ color: COLORS.textPrimary }}>Nursing Home Residents</h4>
                    <p className="text-2xl font-bold" style={{ color: COLORS.textPrimary }}>{data.totalNursingHome.toLocaleString()}</p>
                </div>
            </div>
        </div>
    );

...
- Website: [slainte.app](https://slainte.app/)
...
| Data Type | What We Collect | When | Where It's Stored |
|-----------|----------------|------|-------------------|
| Practice registration | Practice ID (randomly generated identifier), practice name, operating system | Automatically when you first complete setup | Google Workspace (our systems) |
| Feedback submissions | Practice ID, practice name, app version, operating system, current page, transaction and category counts (numbers only), your feedback text, and Finn conversation summary if applicable | When you choose to send feedback | Google Workspace (our systems) and locally on your device |
| Website enquiries | Information you provide via our contact form (name, email, message) | When you contact us via the website | Google Workspace (our systems) |
| Financial data | Transactions, income, expenses, GMS payments, category mappings, practice profile details | During normal use of the application | **Your device only — never on our systems** |
| AI queries | Your questions to Finn and relevant financial context (see Section 5 for detail) | When you use Finn or other AI-powered features | Processed by Anthropic's Claude API (not stored — see Section 5) |
| PCRS credentials | Your HSE PCRS portal login details and session cookies | When you use the PCRS download feature | **Your device only — encrypted local storage** |
...
| Data sent securely to Anthropic | Data never sent under any circumstances |
|---------------------------------|----------------------------------------|
| Your questions to Finn | Bank account numbers, sort codes, or IBANs |
| Aggregated financial totals (e.g. "total expenses: €X") | Individual patient data |
| Category summaries (e.g. "Medical Supplies: €X") | PCRS portal login credentials |
| Practice name and staff/GP names | Your Sláinte Key |
| GMS payment amounts | Raw bank statement files |
| Transaction descriptions (for uncategorised items only, approximately 5% of transactions) | Passwords or API keys |
...
- For more information, see Anthropic's privacy policy at [anthropic.com/privacy](https://anthropic.com/privacy)
...
|-----------|---------|----------------|
| Anthropic (Claude API) | AI-powered features (Finn, categorisation, reports) | Financial summaries and queries as detailed in Section 5 |
| Google Workspace | Feedback collection and customer support | Practice registration data, feedback submissions, and website enquiries as detailed in Section 3 |
...
- **Consent:** When you use Finn or AI features, you consent to your query data being processed by Anthropic. When you accept the Terms and Conditions during setup, you consent to the one-time practice registration
...
You also have the right to lodge a complaint with the Irish Data Protection Commission ([dataprotection.ie](https://dataprotection.ie/)) if you believe your rights have been violated.
